            ...
            <div className="content content-narrow">
                <div className="flex-col gap-16">
                    ...
                    <div className="card">
                        ...
                        <FormField label="Função">
                            <Input value={roleLabel(currentUser?.role)} disabled />
                        </FormField>
                        <FormField label="Grupo (cargo na empresa)">
                            <Input value={currentUser?.group ?? "—"} disabled />
                        </FormField>
                    ...
                    <div className="card">
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: 13, color: C.textSub }}>
                            ...
                            <div className="flex justify-between">
                                <span>Versão</span>
                                <span className="font-500">v{version}</span>
                            </div>
                        </div>
                    </div>
                </div>
